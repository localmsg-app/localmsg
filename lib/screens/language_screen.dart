...
String languageDisplayName(Locale locale) => _nativeNames[locale.languageCode] ?? locale.languageCode;
...
class LanguageScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(l10n.settingsLanguage, style: AppTypography.screenTitle)),
      body: ListView(
                        ...
                        children: [
                          Expanded(
                            child: Text(
                              ...
                              style: const TextStyle(fontFamily: 'Inter', fontSize: 15, color: AppColors.text),
                            ),
                          ),
